...
PARAM_GRID = {
    ...
    #"model-cell_type": ["lstm", "gru",],
    "model-rnn_cell_params-units": [10, 20, 50,],
    "model-bidirectional":[True, False],
    "model-num_layers": [2, 4, 6],
    "model-dilation_base":[None, 2],
    "model-residual_block_size":[None, 2],
    "model-smyl_std": [True, False],
    "model-smyl_residual": [True, False],
}
