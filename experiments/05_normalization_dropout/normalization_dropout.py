...
#OPTIMIZATION_MODE = "bayesopt"
OPTIMIZATION_MODE = "gridsearch"

PARAM_GRID = {
    #"training-optimizer_params-learning_rate": [1e-2, 5e-3, 1e-3, 5e-4, 1e-4],
    #"training-optimizer_params-clipnorm": [0.5, 1., 2., 5., 10., 50., 100.,],
    "model-layer_normalization" : [True, False,],
    "model-dropout" : [0.0, 0.05, 0.1, 0.15, 0.2, 0.3,],
    "model-recurrent_dropout" : [0.0, 0.05, 0.1, 0.15, 0.2 ,0.3,],
}
...
if __name__ == "__main__":
    ...
    bayes_log_path = os.path.join(LOGS_FOLDER, "gradient_clipping_bo.json")
    ...
    optimization.search(
        ...
        gs_csv_log_path=os.path.join(cur_path, "logs", "preprocessing_type_comparison.csv"),
